...
public class PlayerController : MonoBehaviour
{
    ...
    private float targetVerticalRoation = 0;    //목표 수직 회전 각도
    ...
    void HandleRotation()
    {
        ...
        theta = Mathf.Repeat(theta, 360f);          //각도 없이 360을 넘지 않도록 조정

        //수진 회전 처리
        targetVerticalRoation -= mouseY;
